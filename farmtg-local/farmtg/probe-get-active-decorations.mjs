...
const client = new FarmtgClient({
  ...
  logger: { warn: console.warn, log: console.log, error: console.error },
});
...
try {
  console.log('\nCalling action("get_active_decorations", {})...');
  result1 = await client.action("get_active_decorations", {});
...
try {
  console.log('\nCalling action("get_active_decorations", { page: 1 })...');
  result2 = await client.action("get_active_decorations", { page: 1 });
  console.log("Result 2:", JSON.stringify(result2, null, 2));
} catch (e) {
  err2 = e;
  console.error("Error 2:", e.message);
  if (e.serverPayload) {
    console.error("Server payload 2:", JSON.stringify(e.serverPayload, null, 2));
  }
}
